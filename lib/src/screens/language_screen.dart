        ...
        children: [
          ...
          Container(
            ...
            child: const Column(
              ...
              children: [
                Icon(Icons.language, color: Colors.white, size: 48),
                SizedBox(height: 12),
                Text(
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    leading: Container(
                      ...
                      height: 50,
                      decoration: BoxDecoration(
                        color: isSelected ? const Color(0xFF0D5EF9) : Colors.grey.shade200,
                    ...
                    title: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: isSelected ? const Color(0xFF0D5EF9) : Colors.black87,
                      ),
                    ),
                    subtitle: Text(
                      language['native']!,
                    ...
                    trailing: isSelected
                        ? const Icon(Icons.check_circle, color: Color(0xFF0D5EF9), size: 28)
                        : const Icon(Icons.circle_outlined, color: Colors.grey, size: 28),
                    onTap: () => _saveLanguagePreference(language['name']!),
                  ),
                );
              },
            ),
